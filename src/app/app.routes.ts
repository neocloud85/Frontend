...
{
  path: 'dm',
  loadComponent: () => import('./components/mensajes/dm-list/dm-list').then(c => c.DmListComponent)
},
{
  path: 'dm/:id',
  loadComponent: () => import('./components/mensajes/dm-chat/dm-chat').then(c => c.DmChatComponent)
}
